 ...
 * 4 и 5 режим змейки
 * НОЧНОЙ РЕЖИМ!
 * Выврд названия дня недели
 * Назначения дня выводов пар 
 * Оптимизация кода
 * Рандомная анимация
 */
...
#define  TEST        1                   // 0 для выключения. 1 для включения. ФУНКЦИЯ ТЕСТА ЭКРАНА
...
#define  OTK         0                   // 0 для выключения. 1 для включения.  ОТКЛЮЧЕНИЕ ДИСПЛЕЯ В ПРОСТОЕ // Не реализовано
#define  OTK_VER     0                   // ВРЕМЯ ПРОСТОЯ ДО ОТКЛЮЧЕНИЯ ДИСПЛЕЯ // Не реализовано 
...
#define  SBR         55                 //  ВЕРСИЯ СБОРКИ НЕ ТРОГАЙ/ ЕСЛИ ЧТО-ТО ИЗМЕНЯЕТЕ В КОДЕ, СООБЩИТЕ МНЕ!!!
#define  SBR_DATA    22.01.2019         //  ДАТА СБОРКИ НЕ ТРОГАЙ/ ЕСЛИ ЧТО-ТО ИЗМЕНЯЕТЕ В КОДЕ, СООБЩИТЕ МНЕ!!!
